...
_G.packer_plugins = {
  ["FTerm.nvim"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/FTerm.nvim",
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  neon = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/neon",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  sonokai = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/sonokai",
  ...
  ["trouble.nvim"] = {
    loaded = true,
    path = "/home/admin/.local/share/nvim/site/pack/packer/start/trouble.nvim",
